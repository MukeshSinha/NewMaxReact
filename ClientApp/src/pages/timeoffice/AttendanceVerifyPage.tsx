...
export const AttendanceVerifyPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Header Banner matching legacy AttendanceVerifyList */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-white border border-slate-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 tracking-tight">Attendance Verification</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-500 font-medium">Verified by Dept</p>
            <h3 className="text-2xl font-bold text-emerald-600 mt-1 font-mono">{stats.verified}</h3>
          </div>
        ...
        <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-500 font-medium">Pending Sign-off</p>
        ...
        <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-500 font-medium">API Discrepancy / Late</p>
            <h3 className="text-2xl font-bold text-rose-600 mt-1 font-mono">{stats.discrepancy}</h3>
          </div>
      ...
      <div className="p-4 rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-wrap items-center justify-between gap-4 text-xs">
        <div className="flex flex-wrap items-center gap-3.5">
          ...
          <div className="flex items-center gap-2">
            <label htmlFor="dtfrm" className="text-slate-700 font-medium">
              Date of:
            </label>
            <input
              type="date"
          ...
          {/* Shift: Shift */}
          <div className="flex items-center gap-2">
            <label htmlFor="Shift" className="text-slate-700 font-medium">
              Shift:
            </label>
            <select
              id="Shift"
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs shadow-md shadow-indigo-600/20 transition-all flex items-center gap-1.5 disabled:opacity-60"
          >
        ...
        <div className="relative w-full sm:w-60">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-300 rounded-xl pl-8 pr-3 py-1.5 text-xs text-slate-800 placeholder-slate-400 focus:border-indigo-500"
          />
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-slate-700 hover:text-slate-900 font-medium"
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs border border-slate-300 transition-all flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-xs shadow-md shadow-emerald-600/20 transition-all flex items-center gap-2 disabled:opacity-50"
            >
                ...
                filteredRecords.map((r) => {
                  ...
                  return (
                    <tr key={r.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="py-2.5 px-3 text-indigo-600 font-bold">{r.empCode}</td>
                      <td className="py-2.5 px-3 font-sans text-slate-800 font-semibold">{r.name}</td>
                      <td className="py-2.5 px-3 font-sans text-slate-500">{r.department}</td>
                      ...
                      <td className="py-2.5 px-3 text-center text-slate-800 font-bold">{r.inTime}</td>
                      <td className="py-2.5 px-3 text-center text-slate-600">{r.outTime}</td>
                      <td className="py-2.5 px-3 text-center text-emerald-600 font-bold">{r.workHrs}</td>
                      <td className="py-2.5 px-3 text-center font-sans">
                        <span
                      ...
                      <td className="py-2.5 px-3 text-center font-sans">
                        {r.status === 'Verified' ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-rose-50 hover:text-rose-700 transition-colors"
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-amber-50 text-amber-700 border border-amber-200 hover:bg-emerald-50 hover:text-emerald-700 transition-colors"
